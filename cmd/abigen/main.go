...
import (
	...
	"github.com/bitherhq/go-bither/accounts/abi/bind"
	"github.com/bitherhq/go-bither/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the bither contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the bither contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the bither contract Solidity source to build and bind")
