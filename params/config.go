...
var (
	...
	TestnetGenesisHash = common.HexToHash("0x3535353535353535353535353535353535353535353535353535353535353535") // Testnet genesis hash to enforce below configs on
)
