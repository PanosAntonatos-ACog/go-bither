...
Official golang implementation of the Bither protocol.

[![API Reference](
https://camo.githubusercontent.com/915b7be44ada53c290eb157634330494ebe3e30a/68747470733a2f2f676f646f632e6f72672f6769746875622e636f6d2f676f6c616e672f6764646f3f7374617475732e737667
)](https://godoc.org/github.com/bitherhq/go-bither)
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/bitherhq/go-bither?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)
...
| `abigen` | Source code generator to convert Bither contract definitions into easy to use, compile-time type-safe Go packages. It operates on plain [Bither contract ABIs](https://github.com/ethereum/wiki/wiki/Ethereum-Contract-ABI) with expanded functionality if the contract bytecode is also available. However it also accepts Solidity source files, making development much more streamlined. Please see our [Native DApps](https://github.com/bitherhq/go-bither/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts) wiki page for details. |
...
| `rlpdump` | Developer utility tool to convert binary RLP ([Recursive Length Prefix](https://github.com/ethereum/wiki/wiki/RLP)) dumps (data encoding used by the Bither protocol both network as well as consensus wise) to user friendlier hierarchical representation (e.g. `rlpdump --hex CE0183FFFFFFC4C304050583616263`). |
...
With the genesis state defined in the above JSON file, you'll need to initialize **every** Bith node
...
Mining on the public Bither network is a complex task as it's only feasible using GPUs, requiring
...
resources (consider running on a single thread, no need for multiple ones either). To start a Bith
instance for mining, run it with all your usual flags, extended by:

```
$ bith <usual-flags> --mine --minerthreads=1 --etherbase=0x0000000000000000000000000000000000000000
```
...
Please see the [Developers' Guide](https://github.com/bitherhq/go-bither/wiki/Developers'-Guide)
