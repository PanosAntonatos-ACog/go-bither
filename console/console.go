...
import (
	...
	"github.com/bitherhq/go-bither/internal/jsre"
	"github.com/bitherhq/go-bither/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute bither requests through
...
// Welcome show summary of current Bith instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Bith metadata
	fmt.Fprintf(c.printer, "Welcome to the Bith JavaScript console!\n\n")
	c.jsre.Run(`
